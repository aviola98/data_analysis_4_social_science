---
title: "A religião nos discursos do presidente Jair Bolsonaro"
author: "André Viola"
date: "7/13/2021"
output:
   html_document:
...
# A proposta deste trabalho final é a 
Neste projeto eu busco analisar os discursos do presidente Bolsonaro no ano de 2019 com o objetivo de identificar a frequência de referências à religião e às Forças Armadas.
...
```{r}
#juntando as tableas bolsonaro_discursos e bolsonaro_discursos_links com a finalidade de adicionar a coluna "date" 
...
Nota-se que algumas palavras recebem conotação negativa mesmo sendo, de fato, neutras (como o caso do "obrigado").
...
De acordo com INSERIR AUTOR(), esta estatística tem o intuito de mensurar o quanto uma palavra é importante para um documento em uma coleção de documentos. 
